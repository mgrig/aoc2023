...
func main() {
	...
	// // day 22
	// lines := common.GetLinesFromFile("resources/22.txt", true, true)
	// part1 := day22.Part1(lines)
	// fmt.Println("part 1:", part1)

	// // day 23
	// lines := common.GetLinesFromFile("resources/23_test.txt", true, true)
	// part1 := day23.Part1(lines)
	// fmt.Println("part 1:", part1)
